...
- **Sampling over exhaustiveness for ABSA.** Running the full 22-aspect classifier over ~4.2M reviews was never attempted; the pipeline runs over a carefully stratified 10,000-review sample (100 reviews × 100 top-ranked games) instead — a deliberate, documented scope decision, not a silent gap.
