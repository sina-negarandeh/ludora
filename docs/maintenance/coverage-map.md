...
| Search: lexical/semantic/hybrid | `docs/ml/search.md` | `backend/app/services/search_service.py`, `backend/app/schemas/game_query.py` | `README.md`, `docs/product/features.md#9`, `docs/architecture/README.md`, `docs/ml/README.md`, `docs/case-study.md` |
