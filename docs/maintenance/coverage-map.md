...
| Observability (logging/tracing/metrics) | `docs/engineering/observability.md` | `backend/app/core/logging_config.py`, `backend/app/core/otel_config.py`, `backend/app/main.py`, `backend/app/database/session.py`, `observability/` | `AGENTS.md`, `backend/AGENTS.md`, `docs/architecture/README.md` |
