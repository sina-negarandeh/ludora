...
class GameBase(BaseModel):
    ...
    description: str | None = Field(None, description="Rich HTML description of the game, provided by BoardGameGeek.")
    ...
    max_players: int | None = Field(None, description="Maximum number of players supported.")
    mfg_playtime: int | None = Field(None, description="Manufacturer's estimated playtime in minutes.")
    min_playtime: int | None = Field(None, description="Community-reported minimum playtime in minutes.")
    max_playtime: int | None = Field(None, description="Community-reported maximum playtime in minutes.")
    min_age: int | None = Field(None, description="Minimum recommended age.")
    image_path: str | None = Field(None, description="URL or relative path to the game's box art image.")
    thumbnail_url: str | None = Field(None, description="URL to a smaller thumbnail variant of the box art.")
    kickstarted: bool | None = Field(None, description="Whether this game originated as a Kickstarter project.")
    is_reimplementation: bool | None = Field(None, description="Whether this game is a reimplementation of an earlier game.")
    rank: int | None = Field(None, description="The overall BoardGameGeek ranking of the game.")
    num_ratings: int | None = Field(None, description="Total number of users who have rated this game.")
    num_comments: int | None = Field(None, description="Total number of users who have left a text review/comment for this game.")
    rating_distribution: list[int] | None = Field(None, description="Array of 10 integers representing the count of ratings from 1 to 10.")
    subdomain_ranks: dict[str, int] | None = Field(None, description="Dictionary mapping subdomain names (e.g., 'Strategy') to this game's rank within that subdomain.")
    suggested_num_players: list[dict[str, Any]] | None = Field(None, description="Raw BGG community poll: Best/Recommended/Not Recommended vote counts per player count.")
    suggested_playerage: list[dict[str, Any]] | None = Field(None, description="Raw BGG community poll: recommended-age vote counts.")
    suggested_language_dependence: list[dict[str, Any]] | None = Field(None, description="Raw BGG community poll: language-dependence vote counts.")
...
class GameResponse(GameBase):
    bgg_id: int = Field(..., description="The unique BoardGameGeek identifier.")
    customer_summary: str | None = Field(None, description="LLM-generated text summarizing the community's overall sentiment based on reviews.")
...
class PaginatedReviews(BaseModel):
    ...
    rating_breakdown: dict[str, float] | None = None
