...
def main():
    input_file = '../data/raw/reviews/bgg-26m-reviews.csv'
    ratings_out = '../data/processed/master_ratings.csv'
    reviews_out = '../data/processed/master_reviews.csv'
    users_out = '../data/processed/master_users.csv'
